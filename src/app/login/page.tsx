  ...
  return (
    <div className='w-screen h-screen flex justify-center items-center text-black bg-white'>
      <div className="bg-white flex justify-center w-4/5 h-4/5 rounded-3xl">
        <form
          className='desktop:w-2/4 laptop:w-2/4 tablet:w-full phone:w-full h-full flex flex-col justify-center items-center gap-2'
        ...
        >
          ...
          <div>
            <span className='text-sm'>
              ...
              <span className='ml-1 text-blue-500 hover:underline hover:underline-offset-4 hover:cursor-pointer'>
                Sign Up
              </span>
            </span>
          </div>
