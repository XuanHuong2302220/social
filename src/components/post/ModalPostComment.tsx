          ...
          <div className='flex flex-col max-h-full pt-[80px]'>
              <div className='flex flex-col overflow-auto max-h-[85%]' id='commentScroll'>
               ...
               {<div className='flex flex-col gap-3 px-5 pt-3'>
                ...
                { loadingGetComment && comments.length === 0 ?
                  <div className='px-5'>
                    <SkeletonReaction />
                  </div>
              : !loadingGetComment && comments.length === 0 && <h2 className='w-full py-5 text-center text-lg text-textColor font-bold'>No Comment Yet</h2>}
